...
# Lista de modelos base para Voting e Stacking
base_models = [
...
models = [
    (VotingClassifier(estimators=base_models, voting='soft'), "Voting Classifier"),
    (StackingClassifier(estimators=base_models, final_estimator=LogisticRegression()), "Stacking Classifier"),
...
def save_results_to_pdf(results_df, filename='ensemble_results.pdf'):
    ...
    elements = [Paragraph("Relatório de Resultados dos Métodos Ensemble", styles['Title'])]
...
save_results_to_pdf(results_df, filename='ensemble_model_evaluation_results.pdf')
